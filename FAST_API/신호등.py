{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMOuitLxalrbQ1BNi6m1CnK",
  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "        raw -= 1\n",
        "        reasons.append(\"확정/공시 맥락 부족(가점 보수화)\")\n",
        "    if raw > 0 and any_hit(hedging_words):\n",
        "        raw -= 1\n",
        "        reasons.append(\"가능성/검토 등 완화 표현 존재\")\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "9Vb_r2hYwtGC",
        "outputId": "6fab8472-c8b5-4da2-efe6-bc04739d7cd8"
      },
