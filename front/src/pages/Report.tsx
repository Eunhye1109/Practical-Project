  ...
  return (
    <Container id='pdf'>
      ...
      <Content>
        ...
        <ReportSumaryBox data={reportData.rader} cropName={reportData.corpName} aiSumaryData={reportData.aiSumary} similarCorpData={reportFullDummyData.similarCorp} fullData={reportData} />
